...
do
    ...
    do
        ...
        echo $log_path
        python cluster_gcn.py --gpu 3 --dataset ppi --lr 1e-2 --weight-decay 0.0 --psize 50 --batch-size 1 --n-epochs 300 \
          --n-hidden 1024 --n-layers $n_layer --log-every 100 --use-pp --self-loop \
